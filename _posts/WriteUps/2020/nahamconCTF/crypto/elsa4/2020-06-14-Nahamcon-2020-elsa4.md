...
description: >
    Nahamcon 2020 Crypto - elsa4 writeup: cryptography, netcat, LC4
key: keys
aside:
  toc: true
sidebar:
...
![Challenge screenshot](Capture.PNG){: loading="lazy" decoding="async" width="617" height="590"}
...
Take the challenge, give out the source, make it challenging 😄
