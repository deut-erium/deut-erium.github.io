...
description: >
    RACTF 2020 Crypto - 02 writeup: cryptography, classical, vignere
key: ractf202002
aside:
  toc: true
sidebar:
...
Progressing from [01](https://github.com/deut-erium/WriteUps/tree/master/_posts/2020/ractf/crypto/01) we get to `02` and are presented with the following ciphertext
