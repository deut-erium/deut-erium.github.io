...
description: >
    zh3r0 2020 Crypto - Double Fish writeup: cryptography, guess, BlowFish, xor
...
![Deadfish cipher result](deadfish.PNG){: loading="lazy" decoding="async" width="1216" height="918"}
...
![Blowfish result](blowfish.PNG){: loading="lazy" decoding="async" width="1531" height="636"}
