...
description: >
    zh3r0 2020 Crypto - Mix writeup: cryptography, encoding, guess
key: zh3r02020mix
aside:
  toc: true
sidebar:
...
![Keyboard shift diagram](keyboard_shift.PNG){: loading="lazy" decoding="async" width="1215" height="922"}
...
![Spoon cipher reference](spoon.PNG){: loading="lazy" decoding="async" width="1218" height="897"}
