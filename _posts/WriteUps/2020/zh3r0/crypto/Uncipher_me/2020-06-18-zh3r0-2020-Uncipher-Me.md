...
description: >
    zh3r0 2020 Crypto - Uncipher Me writeup: cryptography, guess, fernet, RSA, encoding
...
![ROT47 result](rot47.PNG){: loading="lazy" decoding="async" width="1217" height="922"}
...
![Vigenere cipher result](vignere.PNG){: loading="lazy" decoding="async" width="1216" height="920"}
