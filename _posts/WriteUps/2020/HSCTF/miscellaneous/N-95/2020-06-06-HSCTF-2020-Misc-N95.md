...
description: >
    HSCTF 2020 Misc - N95 writeup: miscellaneous, QR, errorcorrection
...
![Screenshot](Capture.png){: loading="lazy" decoding="async" width="484" height="313"}

Have you seen a QR code? Definitely. Have you seen a masked QR code? WTF!
This is one of my favorite challs from the CTF 😉

![Reconstructed QR code](N-95.png){: loading="lazy" decoding="async" width="1160" height="1160"}
...
![Step 1](step1.jpeg){: loading="lazy" decoding="async" width="1160" height="1160"}
 Reading up and checking the size of our QR code, we realize it is 25x25(version 2). 

 ![QR info](QR_info.png){: loading="lazy" decoding="async" width="1280" height="650"}
 ...
 ![alignment](alignment-exclusion.png){: loading="lazy" decoding="async" width="396" height="396"}

 Since the alignment pattern is already there, we only need to add the position patterns, which is the next step.

 ![Step 2](step2.jpeg){: loading="lazy" decoding="async" width="1160" height="1160"}
 ...
 ![Step 3](step3.jpeg){: loading="lazy" decoding="async" width="1160" height="1160"}
...
![Step 4](step4.jpeg){: loading="lazy" decoding="async" width="385" height="375"}
...
![format_info](format-layout.png){: loading="lazy" decoding="async" width="783" height="783"}
...
Let's compare this partial string with all the format information strings in the table [here](https://www.thonky.com/qr-code-tutorial/format-version-tables). Only match is `101101101001011` 😁. This gives us ECC level as `M` and mask pattern as `3`. Setting this in [qrazybox](https://merricx.github.io/qrazybox/), we get

![Step 5](step5.jpeg){: loading="lazy" decoding="async" width="360" height="351"}
...
![Step 6](step6.jpeg){: loading="lazy" decoding="async" width="360" height="351"}
...
![Step 7](step7.jpeg){: loading="lazy" decoding="async" width="360" height="351"}
...
![Final QR](final.jpeg){: loading="lazy" decoding="async" width="360" height="351"}
![Final QR](final_2.png){: loading="lazy" decoding="async" width="407" height="401"}
